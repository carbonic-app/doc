...
\section{Introduction}
    ...
    \subsection{Intended Audience and Document Overview}
        ...
        \begin{enumerate}
            ...
            \item \emph{Music students}. Students have access to a history of their \glspl{lesson plan}, \glspl{practice-resource}, and communication with their associated instructor or school. 
        \end{enumerate}
